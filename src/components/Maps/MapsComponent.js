...
import { View, StyleSheet, Dimensions, Image, TouchableOpacity, ActivityIndicator } from 'react-native';
...
export default class MapComponent extends Component {
    ...
    render() {
        const component = this.state.locationFetchCompolete && this.state.queryComplete  ?
            <View style={styles.container}>
                ...
                <View style={styles.search}>
                    <TextInput
                        ...
                        onSubmitEditing={(text) => {this.setState({search: ''});}}
                    />
